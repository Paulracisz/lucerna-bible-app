export const dailyVerses = [
 ...
 { reference: "Ephesians 2:8-9", text: "For by grace you have been saved through faith; and this is not from yourselves, it is the gift of God; not from works, so that no one can boast."},
  ...
  { reference: "Isaiah 43:2", text: "When you pass through the waters, I will be with you; and when you go through the rivers, they will not overwhelm you. When you walk through the fire, you will not be scorched; the flames will not set you ablaze."}, 
  { reference: "Mark 9:23", text: "“If You can?” echoed Jesus. “All things are possible to him who believes!"}, 
  { reference: "Isaiah 25:1", text: "O LORD, You are my God! I will exalt You; I will praise Your name. For You have worked wonders—plans formed long ago—in perfect faithfulness."}, 
  { reference: "2 Corinthians 3:17", text: "Now the Lord is the Spirit, and where the Spirit of the Lord is, there is freedom."}, 
  { reference: "1 John 4:16", text: "And we have come to know and believe the love that God has for us. God is love; whoever abides in love abides in God, and God in him."}, 
  { reference: "Romans 12:12", text: "Be joyful in hope, patient in affliction, persistent in prayer."}, 
  { reference: "Psalm 56:3", text: "When I am afraid, I put my trust in You."}, 
  { reference: "Colossians 4:2", text: "Devote yourselves to prayer, being watchful and thankful,"}, 
  { reference: "John 16:33", text: "I have told you these things so that in Me you may have peace. In the world you will have tribulation. But take courage; I have overcome the world!”"}, 
  { reference: "Jeremiah 29:12", text: "Then you will call upon Me and come and pray to Me, and I will listen to you."}, 
  { reference: "Ephesians 5:15", text: "Pay careful attention, then, to how you walk, not as unwise but as wise, redeeming the time, because the days are evil."}, 
  { reference: "2 Corinthians 9:7", text: "Each one should give what he has decided in his heart to give, not out of regret or compulsion. For God loves a cheerful giver."}, 
  { reference: "Acts 16:25", text: "About midnight Paul and Silas were praying and singing hymns to God, and the other prisoners were listening to them."}, 
  { reference: "Ephesians 4:32", text: "Be kind and tenderhearted to one another, forgiving each other just as in Christ God forgave you."}, 
  { reference: "1 Corinthians 6:9-10", text: "Do you not know that the wicked will not inherit the kingdom of God? Do not be deceived: Neither the sexually immoral, nor idolaters, nor adulterers, nor men who submit to or perform homosexual acts, nor thieves, nor the greedy, nor drunkards, nor verbal abusers, nor swindlers, will inherit the kingdom of God."}, 
  { reference: "Galatians 5:22-23", text: "But the fruit of the Spirit is love, joy, peace, patience, kindness, goodness, faithfulness, gentleness, and self-control. Against such things there is no law."}, 
